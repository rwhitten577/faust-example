...
class FaustAvroSerializer(MessageSerializer, Codec):
    """Subclass of Faust serde Codec that uses Confluent-Kafka's MessageSerializer for its decode and encode interfaces"""

    def __init__(self, schema_registry_client=None, destination_topic=None, schema=None, is_key=False):
